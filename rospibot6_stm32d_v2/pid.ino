...
void update_PID() {
  ...
  if(true && leftSpeedPidSetPoint && (leftSpeedPidResult || rightSpeedPidResult)) {
  ...
  // set speed  
  if(leftSpeedPidSetPoint != 0) leftMotorPwmOut = leftSpeedPidOutput * leftSpeedPidSetPointDirection; // - steeringPidOutput;
  if(rightSpeedPidSetPoint != 0) rightMotorPwmOut = rightSpeedPidOutput * rightSpeedPidSetPointDirection; // + steeringPidOutput;
