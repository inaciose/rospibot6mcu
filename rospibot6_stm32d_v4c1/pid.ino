...
void setPidTarget() {
        ...
        Serial.print("pidTarget");  Serial.print("\t"); Serial.print(leftSpeedPidSetPointDirection * leftSpeedPidSetPoint); Serial.print("\t"); Serial.print(rightSpeedPidSetPointDirection * rightSpeedPidSetPoint); Serial.print("\t"); Serial.print(useSteeringPid); Serial.println();
