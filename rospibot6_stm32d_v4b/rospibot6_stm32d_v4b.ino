...
Encoder encoderLeft(ENCODER_LEFT_PINA, ENCODER_LEFT_PINB);
Encoder encoderRight(ENCODER_RIGHT_PINA, ENCODER_RIGHT_PINB);

long encoderLeftPulses = 0; // the number of pulses
long encoderRightPulses = 0; // the number of pulses
long encoderLeftPulsesLast = 0; // the number of pulses
long encoderRightPulsesLast = 0; // the number of pulses

// stop on encoder position target
...
// pid
long encoderLeftPulsesSpeedPID = 0; // the number of pulses for PID
long encoderLeftPulsesSteeringPID = 0; // the number of pulses for PID, must be reset at same time
long encoderRightPulsesSpeedPID = 0; // the number of pulses PID
long encoderRightPulsesSteeringPID = 0; // the number of pulses for PID, must be reset at same time
...
//#define ENCODER_LEFT_PINA PA4
//#define ENCODER_LEFT_PINB PA5
#define ENCODER_LEFT_PINA PA5
#define ENCODER_LEFT_PINB PA4
...
//#define ENCODER_RIGHT_PINA PA6
//#define ENCODER_RIGHT_PINB PA7
#define ENCODER_RIGHT_PINA PA7
#define ENCODER_RIGHT_PINB PA6
...
void update_encoders() {
  ...
  encoderLeftPulsesLast = encoderLeftPulses;
  encoderRightPulsesLast = encoderRightPulses;
  
  encoderLeftPulses = encoderLeft.read();
  encoderRightPulses = encoderRight.read();

  deltaLeft = encoderLeftPulses - encoderLeftPulsesLast;
  deltaRight = encoderRightPulses - encoderRightPulsesLast;

  encoderLeftPulsesSpeedPID += deltaLeft;
  encoderLeftPulsesSteeringPID += deltaLeft;
  
  encoderRightPulsesSpeedPID += deltaRight;
  encoderRightPulsesSteeringPID += deltaRight;
}
